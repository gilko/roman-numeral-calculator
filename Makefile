...
$(TEST-SUITE): $(ODIR)/all-tests.o $(ODIR)/calculator-test.o $(ODIR)/roman-numerals-sorter-test.o $(ODIR)/roman-numerals-converter-test.o $(ODIR)/common-utils-test.o $(ODIR)/calculator.o $(ODIR)/roman-numerals-sorter.o $(ODIR)/roman-numerals-converter.o $(ODIR)/common-utils.o
	$(CC) $(CFLAGS) -o $(TEST-SUITE) $(ODIR)/all-tests.o $(ODIR)/calculator-test.o $(ODIR)/roman-numerals-sorter-test.o $(ODIR)/roman-numerals-converter-test.o $(ODIR)/common-utils-test.o $(ODIR)/calculator.o $(ODIR)/roman-numerals-sorter.o $(ODIR)/roman-numerals-converter.o $(ODIR)/common-utils.o $(LIBS)
	mv $(TEST-SUITE) $(BIN)

$(ODIR)/all-tests.o: $(TDIR)/all-tests.c $(TDIR)/calculator-test.h $(TDIR)/roman-numerals-sorter-test.h $(TDIR)/roman-numerals-converter-test.h $(TDIR)/common-utils-test.h
